...
/**
 * InvestigationNav — premium participant navigation.
 *
 * Desktop: inline segmented strip with subtle depth.
 * Mobile: premium bottom navigation with 3D layering.
 *
 * Active tab has clear visual state. Inactive tabs are quiet and restrained.
 * No leaderboard for participants.
 */
  ...
  return (
    <nav
      ...
      className={cn(
        ...
        "bg-abyss-950/95 backdrop-blur-md",
        "pb-[env(safe-area-inset-bottom)]",
        "lg:static lg:border-x-0 lg:border-b lg:border-t-0 lg:bg-abyss-950/50 lg:pb-0",
      )}
      style={{
              ...
              <li key={tab.key} className="min-w-0 lg:w-auto">
                <Link
                  ...
                  className={cn(
                    ...
                    "transition-all duration-200 lg:flex-row lg:gap-2.5 lg:rounded-none lg:px-4 lg:py-2",
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className={cn(
                      "absolute inset-x-3 top-0 h-px bg-acid transition-opacity duration-200 lg:hidden",
                  ...
                  <span
                    aria-hidden
                    className={cn(
                      "hidden h-4 w-px bg-acid transition-opacity duration-200 lg:block",
                      isActive ? "opacity-100" : "opacity-0",
                    )}
                  />
                  <Icon
                    className={cn(
                      "h-[18px] w-[18px] shrink-0 transition-transform duration-200 lg:h-4 lg:w-4",
